...
public class UserApi {
    ...
    @RequestMapping(value = "/snow/vote" , method = RequestMethod.GET)
    @ResponseBody
    ...
    @ResponseBody
    public Map<String,Object> selectWorkList(@RequestParam(value = "page") int page){
        logger.info("GET work : ");

        Map<String,Object> data = null;
        try{
            data = userService.selectWork(page);
        }catch (SnowException e){
            e.printStackTrace();
        }
        return data;
